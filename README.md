...
│
├── context/                 # Replacement for Zustand/MobX (Your native FavoritesContext will go here)
│
...
│
├── routes/                  # We'll configure the React Router v6+ router here
│
├── store/                   # (Optional) Created out of habit; using Context API we can omit it or use it only for very simple states.
│
